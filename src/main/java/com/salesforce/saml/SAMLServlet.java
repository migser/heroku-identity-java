...
public class SAMLServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        if (samlMetadata != null) {
            ...
            try {
                ...
                if (certXPathResult.getLength() != 1)
                    throw new ServletException("No X509Certificate node");
                ...
                if (cert == null)
                    throw new ServletException("No cert in cert node");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!INITIALIZED) {
            ...
            String redirect = IDP_URL + "?SAMLRequest=" + SAMLRequest + "&expid=damm";
            if (relayState != null)
